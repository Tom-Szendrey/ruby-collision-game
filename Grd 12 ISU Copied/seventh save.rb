...
instructionText, This will be used for writing on my instruction screen
winBackground, This is the background used for the end game screen when you've won
mainText, This is the text that will be written onto the main/home screen
backgroundImage This will be used for the main menu's background
menuX This is used as the x comp. to draw the text on the main menu
menuY This is used as the y comp. to draw the text on the main menu
gameStart This will be used to determine which screen will be present.
losingText This will be used to write text onto the slosing game screen
losingInstructions This will be used to write instructions onto the losing screen
loseGameBackground This will be used as a background when you lose the game
xLosingBackground This is the x component of the image stated above
yLosingBackground This is the y comp. of the image stated above
blockX[] This will be used to store the x components of all of the blocks
blockY[] This will be used to store the y comp. of all the blocks
block(number) This will be used to draw the blocks
player  This will be the player
x_player This is the player's x component
y_player this is the player's y comp.
gameBackground This is the background while the game is being played
xFactorBackground This will be used to resize the background to fit (x comp.)
yFactorBackground This will be used to resize the background to fit (y comp.)
scoreMessage This is the score message (Top right)
timeMessage This is the time message (top right)
coinCount This will be used to count how many coins have been collected
coin This is the image of the coin
coinX X comp. of the coin
coinY Y comp. of the coin
difficultyTimer This will be used to raise the difficulty every 5 seconds until the max difficulty is reached
SecondTimer This will be used to prevent an if statement from running multiple times a second
score This is how much score you have
scoreText This will be used to display the score
...
class Main < Gosu::Window
  ...
  def initialize(width=800, height= 600, fullscreen=false)
    ...
    #for instructions
    @instructionText =  Gosu::Image.from_text self, 'Dodge Asteroids, get Satellites, last until 9001 points
W,A,S,D to move
Click G to win
Press R for main Menu, or C to start game', Gosu.default_font_name, 30
...
Click C to continue
press i for intructions', Gosu.default_font_name, 50
...
press R to Restart', Gosu.default_font_name, 25
  ...
  def update
    ...
    #to bring to instruction screen
  ...
  def draw
    ...
    if @gameStart == 5
      @backgroundImage.draw(0,0,0)
      @instructionText.draw((self.width - @instructionText.width)/2,(self.height - @instructionText.height)/2, 0)
    end
